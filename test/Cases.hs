...
imports =
  testGroup
    ...
    [ runImportSuccess "booldef.solc",
      ...
      runImportSuccess "namedinst_qualified_main.solc",
      runImportSuccess "namedinst_select_main.solc",
...
cases =
  testGroup
    ...
    [ runTestForFile "Ackermann.solc" caseFolder,
      ...
      runTestExpectingFailure "named-inst-default-fail.solc" caseFolder,
      runTestForFile "named-inst-function-method-collision.solc" caseFolder,
      runTestExpectingFailure "named-inst-no-matching-head.solc" caseFolder,
      runTestExpectingFailure "named-inst-not-implicit.solc" caseFolder,
